/**
 *Utility class for HTML form encoding. This class contains static methods for converting a String to the application/x-www-form-urlencoded MIME format. For more information about HTML form encoding, consult the HTML <a href="https://www.w3.org/TR/html4/">specification</a>.
 *When encoding a Str Utility classing, the following rules apply:
 * 
 * <ul>
...
public class URLEncoder extends Object{
     ...
     * <br><strong>Note</strong>: The <a href="UnsupportedEncodingException">World Wide Web Consortium Recommendation</a> states that UTF-8 should be used. Not doing so may introduce incompatibilites.
     * @param s String to be translated.
     * @param enc The name of a supported <a href="UnsupportedEncodingException">character encoding</a>.
     * @return the translated String.
     * @exception  UnsupportedEncodingException
     *             If the named encoding is not supported
     * @since 1.4
     * @see <a href="UnsupportedEncodingException">URLDecoder.decode(java.lang.String, java.lang.String)</a>
     */
